...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $status = "notverified";
        $insert_data = "INSERT INTO users (name, password, email, mobile, code, status, added_on, address)
                        values('$name', '$encpass', '$email','$mobile', '$code', '$status', '$added_on', '$address')";
        ...
        if($data_check){
            ...
            include('smtp/PHPMailerAutoload.php');
                ...
                $mail->SMTPSecure="tls";
                $mail->SMTPAuth=true;
                $mail->Username="sanduher92@gmail.com";
                $mail->Password="Sanhm98@#9.";
                $mail->SetFrom("sanduher92@gmail.com");
