       				...
       				<div class="col-lg-4 offset-md-1">
       					<div class="contact_details">
       						<div class="contact_d_item">
       							<h3>Address :</h3>
       							<p>Sanjana Rajapaksha<br>256, Kandy Street<br/>Peradeniya</p>
       						</div>
       						<div class="contact_d_item">
       							<h5>Phone : <a href="tel:01372466790">075-7182568</a></h5>
       							<h5>Email : <a href="mailto:shaineycakes@contact.com">shaineycakes@contact.com</a></h5>
       						</div>
       						<div class="contact_d_item">
       							<h3>Opening Hours :</h3>
