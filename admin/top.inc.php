...
<head>
    ...
    <title>Shainy Cake Admin Panel</title>
...
<body>
    ...
    <header>
        ...
        <div class="left_area">
            <a href="#">Shainy_Cake <span>Admin</span></a>
        </div>
    ...
    <div class="sidebar">
        <div class="profile_info">
            <img src="images/aa.png" class="admin_profile" alt="">
        <h5>Sanjana Rajapaksha</h5>
        </div>
        <a href="index.php"><i class="fas fa-home"></i><span>Dashboard</span></a>
      <!--   <a href="chat/users.php"><i class="fas fa-comments"></i><span>Dashboard</span></a> -->
        <!-- <a href="banner.php"><i class="fas fa-flag"></i><span>Banner</span></a> -->
        <a href="categories.php"><i class="fas fa-sitemap"></i><span>Categories</span></a>
